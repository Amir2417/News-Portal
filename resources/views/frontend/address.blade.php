...
<body>
    ...
    <!-- Main Section Start -->
    <main>
        <h1 style="margin-left: 30px;">Address Information</h1>
        @foreach ($addresses as $address)
            <div class="address">
                <h4 style="margin-left: 30px;">Location : {{ $address->lctn_add}}</h4>
                <h4 style="margin-left: 30px;">Phone : {{ $address->lctn_phone}}</h4>
                <h4 style="margin-left: 30px;">Email : {{ $address->lctn_email}}</h4>
            </div>
        @endforeach
